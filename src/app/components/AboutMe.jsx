...
export default function AboutMe(){
    return(
        ...
        <section id="about" className="relative flex gap-4 px-2 md:px-10 lg:px-16 py-3">
            <div className="flex-1"><SectionReveal>
            ...
            <div className="rounded-full">
                <Image src="/images/About-image.webp" alt="Myself" height={360} width={360} className=" w-60  rounded-full object-cover"/>
            </div></SectionReveal></div>
        </section>
    );
}